...
val stats : (string * decimal) [] =
  [|("4.2", 14660M); ("4.1", 52019M); ("4.0", 31619M); ("3.3", 617666M);
    ("3.2", 15205M); ("3.1", 172151M); ("3.0", 335493M); ("2.4", 386066M);
    ("2.3", 453725M); ("2.2", 277596M); ("2.1", 26249M); ("2.0", 77727M);
    ("1.1", 68923M); ("1.0", 17948M)|]*)
(**
